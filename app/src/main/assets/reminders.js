...
.lesson-favorite:active{transform:scale(.88)!important}.lesson-favorite.on::after{content:'';position:absolute;inset:-7px;border-radius:50%;pointer-events:none;background:repeating-conic-gradient(from 0deg,transparent 0deg,transparent 16deg,rgba(255,216,106,.34) 17deg,rgba(255,216,106,.34) 19deg,transparent 20deg,transparent 45deg);-webkit-mask:radial-gradient(circle,transparent 0 48%,#000 50% 58%,transparent 62%);mask:radial-gradient(circle,transparent 0 48%,#000 50% 58%,transparent 62%);opacity:.42;transform:scale(.88) rotate(0deg);animation:favoriteRays 7s ease-in-out infinite}.lesson-favorite.on{color:#ffd86a!important;background:rgba(255,216,106,.10)!important;border-color:rgba(255,216,106,.28)!important;text-shadow:0 0 8px rgba(255,216,106,.75),0 0 16px rgba(255,216,106,.3)!important;box-shadow:0 0 16px rgba(255,216,106,.12)!important}
...
@keyframes favoriteRays{0%,100%{opacity:.28;transform:scale(.86) rotate(0deg)}50%{opacity:.58;transform:scale(1.02) rotate(18deg)}}
@media(prefers-reduced-motion:reduce){.lesson-favorite.on::after{animation:none!important}}
