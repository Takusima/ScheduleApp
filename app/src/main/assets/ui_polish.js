...
html[data-cf-glass=true] .nav-btn.active{background:transparent!important;box-shadow:none!important}html[data-cf-glass=true] .nav-btn.active::before{background:linear-gradient(135deg,rgba(166,108,255,.24),rgba(121,69,214,.16))!important;box-shadow:inset 0 1px rgba(255,255,255,.08)!important}
