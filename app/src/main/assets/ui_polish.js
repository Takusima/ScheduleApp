...
html[data-cf-glass=true] .primary-btn:active,html[data-cf-glass=true] .secondary-btn:active,html[data-cf-glass=true] .wide-btn:active,html[data-cf-glass=true] .outline-btn:active,html[data-cf-glass=true] .day-btn:active,html[data-cf-glass=true] .cf-btn:active{transform:scale(.975)!important}
html[data-cf-glass=true] .primary-btn{background:linear-gradient(135deg,rgba(166,108,255,.45),rgba(121,69,214,.30))!important}
html[data-cf-glass=true] .nav-btn{position:relative;border-radius:16px;background:linear-gradient(135deg,rgba(255,255,255,.13),rgba(255,255,255,.07))!important;border:1px solid rgba(255,255,255,.08)!important;box-shadow:none!important}html[data-cf-glass=true] .nav-btn.active{background:linear-gradient(135deg,rgba(166,108,255,.34),rgba(121,69,214,.22))!important;box-shadow:none!important}
