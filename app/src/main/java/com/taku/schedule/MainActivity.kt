        ...
        web=WebView(this).apply{
            ...
            webViewClient=object:WebViewClientCompat(){
                ...
                override fun onPageFinished(view:WebView?,url:String?){super.onPageFinished(view,url);view?.evaluateJavascript("""
                    ...
                    addScript('scheduleCustomizationScript','./customization.js');addScript('scheduleRemindersScript','./reminders_optimized.js');addScript('scheduleFavoritesInstantScript','./favorites_instant.js');addScript('schedulePerformanceScript','./performance.js');addScript('scheduleExtrasScript','./schedule_extras.js');addScript('scheduleCustomFeaturesScript','./custom_features.js');addScript('scheduleUiPolishScript','./ui_polish.js');addScript('scheduleWidgetSyncScript','./widget_sync.js');addScript('scheduleCurrentLessonFixScript','./current_lesson_fix.js');
