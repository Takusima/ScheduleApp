    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        assetLoader = WebViewAssetLoader.Builder()
            ...
            .addPathHandler("/schedule/", WebViewAssetLoader.PathHandler { path ->
                ...
                try {
                    WebResourceResponse("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", null, file.inputStream())
            ...
            .addPathHandler("/background/", WebViewAssetLoader.PathHandler { path ->
                ...
                val safeMime = when (mime) {
                    "image/gif", "image/webp", "image/png", "image/jpeg" -> mime!!
                    else -> "image/jpeg"
                }
        ...
        web = WebView(this).apply {
            ...
            webViewClient = object : WebViewClientCompat() {
                ...
                override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest): Boolean {
                    val u = request.url
                    val tg = u.scheme.equals("tg", true) || (u.scheme.equals("https", true) && u.host.equals("t.me", true))
                    if (tg) {
                ...
                override fun onPageFinished(view: WebView?, url: String?) {
                    ...
                    view?.evaluateJavascript("""
                        ...
                        addScript('scheduleCustomizationScript','./customization.js');addScript('scheduleRemindersScript','./reminders_optimized.js');addScript('scheduleFavoritesInstantScript','./favorites_instant.js');addScript('schedulePerformanceScript','./performance.js');addScript('scheduleExtrasScript','./schedule_extras.js');addScript('scheduleCustomFeaturesScript','./custom_features.js');addScript('scheduleUiPolishScript','./ui_polish.js');addScript('scheduleWidgetSyncScript','./widget_sync.js');addScript('scheduleCurrentLessonFixScript','./current_lesson_fix.js');addScript('scheduleGroupLockScript','./group_lock.js');addScript('scheduleSmoothDaysScript','./smooth_days.js');addScript('scheduleSubjectsScript','./subjects.js');addScript('scheduleBellFixScript','./bell_schedule_fix.js');
