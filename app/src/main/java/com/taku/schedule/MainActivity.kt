        ...
        web=WebView(this).apply{
            ...
            webViewClient=object:WebViewClientCompat(){
                ...
                override fun onPageFinished(view:WebView?,url:String?){super.onPageFinished(view,url);view?.evaluateJavascript("""
                    ...
                    addScript('scheduleCustomizationScript','./customization.js');addScript('scheduleRemindersScript','./reminders_optimized.js');addScript('schedulePerformanceScript','./performance.js');addScript('scheduleExtrasScript','./schedule_extras.js');addScript('scheduleCustomFeaturesScript','./custom_features.js');
